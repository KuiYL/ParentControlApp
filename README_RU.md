...
<p align="center">
  <a href="https://github.com/KuiYL/ParentControlApp/releases/latest">
    <img src="https://img.shields.io/badge/Скачать-APK-4CAF50?style=for-the-badge&logo=android&logoColor=white" alt="Download APK" />
  </a>
</p>
...
**Демонстрационная версия** — бэкенд Supabase в настоящее время отключён.
...
- ✅ Локальные настройки темы
- ✅ Визуализация компонентов UI

Для полноценной работы необходимо настроить собственный Supabase backend (см. раздел "Установка и запуск").
